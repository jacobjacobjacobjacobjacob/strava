# src/api/strava_api/strava_api.py
import requests
import sys
import time
...
class StravaClient:
    def __init__(
        ...
        logger.success(f"Initializing StravaClient for athlete id: '{athlete_id}'")
    ...
    def get_athlete_info(self):
        """Fetch general stats about the authenticated athlete."""
        return self.make_request(f"athlete")
